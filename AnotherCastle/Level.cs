...
namespace AnotherCastle
{
    class Level
    {
        ...
        public Level(Input input, TextureManager textureManager, PersistentGameData gameData)
        {
            ...
            _enemyManager = new EnemyManager(textureManager1, _effectsManager, _missileManager, new ClientBounds { NorthBound = 400, SouthBound = -400, EastBound = -640, WestBound = 640, });
